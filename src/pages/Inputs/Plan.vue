          ...
          <table class="sheet_table">
            ...
            <tr>
              ...
              <td>
                ...
                <p class="btn_select"><a href="">選択</a></p>
                <p class="btn_all_day"><a href="">クリア</a></p>
              </td>
            </tr>
        ...
        <ul>
          <li>
            <label class="check_data">
              <input type="radio" name="activity" value="">新設活動
            </label>
          </li>
          <li class="">
            <label class="check_data">
          ...
          <li class="">
            <label class="check_data">
              <input type="radio" name="activity" value="">増収対策
            </label>
          </li>
          <li class="">
            <label class="check_data">
              <input type="radio" name="activity" value="">新規案件・クロスセル
            </label>
          </li>
          <li class="">
            <label class="check_data">
              <input type="radio" name="activity" value="">ＭＳＡ生命
            </label>
          </li>
          <li class="">
            <label class="check_data">
              <input type="radio" name="activity" value="">日本生命
            </label>
          </li>
        </ul>
      </div>
